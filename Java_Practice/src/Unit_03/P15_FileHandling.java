...
class ABCDEF {
	...
	void takeInputFromAFile() throws IOException {
		...
		String path = "E:\\my_work\\Learning_Java\\Java_Practice\\src\\Unit_03\\input";
...
//		}
	...
	void saveOutputIntoAFile() throws IOException {
		...
		try {
			myObj = new FileWriter("/Java_Practice/src/Unit_03/output.txt");
		} catch (IOException e) {
	...
	void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("/Java_Practice/src/Unit_03/log.txt",true);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
